 ...
 * 
 * @author MOHANARANGAN
 * @see used to maintain bookHotel page StepDefinition
 * @Date 26/01/2023
 */
public class TC4_BookHotelStep {
	...
	public void user_should_book_the_hotel_and(String firstName, String lastName, String billingAddress,
		...
		pom.getBookHotelPage().selectAllFields(firstName, lastName, billingAddress, ccNum, ccType, expMonth, expYear,
				cvv);
	...
	public void user_should_verify_after_book_the_hotel_get_success_message_and_save_the_generated_order_id(
		...
		WebElement msg = pom.getBookingConfirmationPage().getBookingConfirmationSuccessMsg();
		String text = msg.getText();
		String bookingConfirmPageId = pom.getBookingConfirmationPage().bookingConfirmPageId();
	...
	public void user_should_verify_error_message_and(String actFirstNameErrorMsg, String actLastNameErrorMsg,
		...
		WebElement laststNameErrorMsg = pom.getBookHotelPage().getLaststNameErrorMsg();
		...
		WebElement creditCardErrorMsg = pom.getBookHotelPage().getCreditCardErrorMsg();
		...
		WebElement cardExpErrorMsg = pom.getBookHotelPage().getCardExpErrorMsg();
