 ...
 * 
 * @author MOHANARANGAN
 * @see used to maintain search hotel page stepDefinitions
 * @date 26/01/2023
 */

public class TC2_SearchHotelStep extends BaseClass2 {
	...
	public void user_should_verify_after_search_hotel_get_the_error_message_and(String actCheckInErrorMsg,
		...
		WebElement noCheckIn = pom.getSearchHotelPage().getNoCheckIn();
		...
		WebElement noCheckOut = pom.getSearchHotelPage().getNoCheckOut();
	...
	public void user_should_verify_after_search_hotel_get_the_error_message(String actSearchHotelErrorMsg) {
		WebElement noLocation = pom.getSearchHotelPage().getNoLocation();
